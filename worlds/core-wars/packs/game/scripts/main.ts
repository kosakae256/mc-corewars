...
system.beforeEvents.startup.subscribe((init) => {
  ...
  // init.blockComponentRegistry.registerCustomComponent("game:example", {
  //   onStepOn: (e, params) => { /* ... */ },
  // });
  //
  // 例: アイテム用 Custom Component の登録
  // init.itemComponentRegistry.registerCustomComponent("game:example", {
  //   onUse: (e, params) => { /* ... */ },
  // });
  void init;
});
...
world.afterEvents.worldLoad.subscribe(() => {
  world.sendMessage("§agame§r loaded.");
  main();
});
