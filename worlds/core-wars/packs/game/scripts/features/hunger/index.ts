 ...
 * **速さをこちらから設定する口が無い。** 足すことでしか増やせない。
 *
 * > ### 0.5 秒ごとは速すぎた（2026-09-01 変更）
 * >
 * > バニラとほぼ同じ速さをもう 1 本流す＝**倍速**にしていたが、
 * > **削り合いが成立しなくなった。**
 * > **2 秒に 1**——バニラはバニラで動かしたまま、**細く足すだけ**にする。
 */
const HEAL_INTERVAL = 40;
