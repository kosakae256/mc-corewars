...
system.beforeEvents.startup.subscribe((init) => {
  ...
  // init.blockComponentRegistry.registerCustomComponent("kit:example", {
  //   onStepOn: (e, params) => { /* ... */ },
  // });
  //
  // 例: アイテム用 Custom Component の登録
  // init.itemComponentRegistry.registerCustomComponent("kit:example", {
  //   onUse: (e, params) => { /* ... */ },
  // });
  void init;
});
...
world.afterEvents.worldLoad.subscribe(() => {
  world.sendMessage("§akit§r loaded.");
  main();
});
