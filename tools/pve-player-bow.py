...
PACK = sys.argv[2] if len(sys.argv) > 2 else "worlds/pve/packs/pve"
...
BOWS = ["pve:bow_common", "pve:bow_plain", "pve:bow_stardust"]
...
COND = f"query.is_item_name_any('slot.weapon.mainhand', {items}) && query.main_hand_item_use_duration > 0.0"
