...
COLORS = {
    "air": (20, 22, 28),
    # ---- pve-v3 の 20 マップで使う（2026-09-04 追加）
    "sand": (219, 207, 163), "red_sand": (190, 103, 50), "sandstone": (216, 203, 155),
    "cut_sandstone": (219, 208, 163), "chiseled_sandstone": (214, 202, 155),
    "smooth_sandstone": (224, 214, 172), "andesite_slab": (136, 136, 136),
    "quartz_pillar": (236, 232, 225), "quartz_bricks": (232, 227, 219),
    "chiseled_quartz_block": (238, 234, 227), "light_blue_stained_glass": (150, 200, 235),
    "white_stained_glass": (236, 240, 243), "tinted_glass": (60, 56, 66),
    "end_rod": (232, 226, 214), "enchanting_table": (60, 43, 61), "chest": (162, 130, 78),
    "snow": (245, 250, 250), "snow_layer": (245, 250, 250), "ice": (144, 178, 235),
    "packed_ice": (141, 180, 226), "blue_ice": (116, 167, 253), "powder_snow": (248, 253, 253),
    "lava": (222, 106, 24), "magma": (140, 62, 30), "netherrack": (97, 38, 38),
    "crimson_nylium": (130, 31, 31), "soul_sand": (81, 62, 50),
    "bamboo": (126, 158, 44), "jungle_log": (85, 67, 25), "jungle_leaves": (61, 118, 32),
    "prismarine": (99, 156, 151), "prismarine_bricks": (99, 171, 158),
    "dark_prismarine": (52, 92, 76), "sea_lantern": (219, 232, 227),
    "mycelium": (111, 100, 102), "red_mushroom_block": (176, 46, 38),
    "brown_mushroom_block": (149, 111, 78), "terracotta": (152, 94, 67),
    "quartz_block": (236, 233, 226), "end_stone": (221, 223, 165),
    "moss_carpet": (89, 109, 45), "azalea_leaves": (91, 122, 47),
    "spruce_planks": (114, 84, 48), "spruce_fence": (114, 84, 48),
    "birch_planks": (192, 175, 121), "cobblestone_wall": (127, 127, 127),
    "oak_stairs": (162, 130, 78), "oak_slab": (162, 130, 78),
    "cactus": (86, 125, 41), "dead_bush": (110, 88, 48),
    "pve_v3:portal": (150, 70, 210),
    ...
    # ---- ネザー系（2026-09-06 追加。`fortress` が一面マゼンタになっていた）
    #
    # **Bedrock の ID は `nether_brick`**（Java の `nether_bricks` ではない）
    "nether_brick": (44, 21, 26), "chiseled_nether_bricks": (40, 20, 24),
    "cracked_nether_bricks": (40, 19, 23), "red_nether_brick": (68, 5, 6),
    "nether_brick_fence": (44, 21, 26), "nether_wart_block": (114, 3, 3),
    "warped_wart_block": (22, 119, 121), "shroomlight": (241, 148, 78),
    "soul_soil": (75, 58, 50), "nether_wart": (114, 20, 22),
    "red_mushroom": (204, 60, 55), "brown_mushroom": (150, 118, 92),
    "crimson_roots": (139, 15, 47), "nether_sprouts": (23, 148, 138),
    "basalt": (73, 72, 78), "polished_basalt": (99, 98, 103),
    "smooth_basalt": (64, 64, 70), "blackstone": (42, 35, 40),
    "polished_blackstone": (53, 48, 56), "polished_blackstone_bricks": (49, 44, 51),
    "chiseled_polished_blackstone": (52, 46, 53), "gilded_blackstone": (60, 42, 39),
    "magma_block": (140, 62, 30), "crimson_stem": (105, 51, 76),
    "crimson_planks": (101, 48, 70), "crimson_hyphae": (95, 42, 66),
    "obsidian": (21, 18, 30), "crying_obsidian": (34, 15, 62),
    # ---- 2026-09-06 追加（マップの生成器が使っていて、紫で出ていたもの）
    # ---- 大書庫・洋館まわり（2026-09-06 追加）
    "white_wool": (244, 246, 246), "light_gray_wool": (142, 142, 134),
    "white_concrete": (207, 213, 214), "light_gray_concrete": (125, 125, 115),
    "light_gray_stained_glass": (172, 176, 176), "clay": (160, 166, 179),
    "chiseled_bookshelf": (172, 142, 90), "lectern": (154, 122, 70),
    "ladder": (150, 120, 72), "rail": (140, 132, 120),
    "red_carpet": (150, 52, 48), "brown_carpet": (114, 71, 40),
    "white_carpet": (233, 236, 236), "light_gray_carpet": (142, 142, 134),
    "purple_stained_glass": (126, 61, 181), "dark_oak_slab": (66, 43, 20),
    "stripped_spruce_log": (149, 118, 74), "copper_block": (192, 107, 79),
    "waxed_weathered_copper": (108, 153, 129), "waxed_oxidized_copper": (82, 162, 132),
    "soul_campfire": (60, 150, 150),
    "bone_block": (222, 219, 200), "candle": (226, 216, 190),
    "soul_torch": (86, 196, 196), "bookshelf": (162, 132, 79), "end_portal_frame": (60, 88, 80),
    "grass_block": (106, 146, 68), "iron_chain": (74, 78, 84),
    "mossy_stone_brick_wall": (112, 120, 100), "skeleton_skull": (206, 203, 195),
    "soul_lantern": (98, 190, 190), "web": (222, 226, 230),
    "pve_v3:portal": (110, 60, 170),
    "calcite": (223,224,220),
